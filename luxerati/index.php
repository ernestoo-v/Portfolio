...
$noticias =$database->get2News();
$coches =$database->get2Cars();
$eventos =$database->get2Events();

function imprimeCardsNoticias($cosas)
{
    foreach ($cosas as $fila) {
        echo '<div>';

        echo '<div class="contenidoNoticias">';

        echo '<img src="' . 'ftos/index/noticias' . '\\' . strtolower($fila['nombre_noticias'])  . '.jpg' . '" alt="" srcset="">';
        echo '<article>';
...
function imprimeCardsCoches($cosas)
{
    foreach ($cosas as $fila) {
        ...
        echo '<img src="' . 'ftos/index/tienda/fotos-inicio' . '\\' . strtolower($fila['marca_coche'])  . '-' .  strtolower($fila['modelo_coche'])  . '.jpg' . '" alt="" srcset="">';
        echo '<article>';
        echo '<a href="">';
...
function imprimeCardsEventos($cosas)
{
    foreach ($cosas as $fila) {
        ...
        echo '<img src="' . 'ftos/index/eventos/' . '\\' . strtolower($fila['nombre_evento']) . '.jpg' . '" alt="." srcset="">';
        ...
        <div id="div1">
            <section class="slider-principal">
                <div id="slider">
                    <figure>
                        <div class="articulo">
                            <img src="ftos/index/slider/ferrari-slider.jpg" alt="">
                        ...
                        <div class="articulo">
                            <img src="ftos/index/slider/rolls-slider.jpg" alt="">
                        ...
                        <div class="articulo">
                            <img src="ftos/index/slider/bugatti-slider.jpg" alt="">
                        ...
                        <div class="articulo">
                            <img src="ftos/index/slider/lamborghini-slider.jpg" alt="">
                            <a href="https://www.topspeed.com/things-you-need-to-know-about-the-28-million-rolls-royce-boat-tail/#the-exotic-car-features-a-neatly-tailored-and-detailed-exterior">
            ...
            <section class="sect">
                <video src="https://www.pexels.com/es-es/video/rio-negro-coche-deportivo-estacionado-9129105/" autoplay loop muted plays-inline></video>
            </section>
        </div>
    </main>
    <footer>
