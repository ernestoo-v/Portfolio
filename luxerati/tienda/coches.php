...
function imprimeCards($cosa)
{
    ...
    echo '<img src="../ftos/index/tienda/coches/' . strtolower($cosa['marca_coche'])  . '-' .  strtolower($cosa['modelo_coche'])  . '/portada.jpg" alt="" srcset="">';
    ...
    $imagenes = array('asiento.jpg', 'coche1.jpg', 'coche2.jpg', 'coche3.jpg', 'coche4.jpg', 'motor.jpg', 'rueda.jpg', 'volante.jpg');
